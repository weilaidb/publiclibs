...
/*============================================
* FuncName    : check_color_terminal
* Description :
* @--         :
* Author      :
* Time        : 2017-05-30
============================================*/
void check_color_terminal(void)
{
...
/*
Set and Get for use_color
*/
void set_use_color(int _use_color)
{
    use_color = _use_color;
}

int get_use_color(void)
{
    return use_color;
}
...
///*============================================
//* FuncName    : av_default_get_category
//* Description :
//* @ptr        :
//* Author      :
//* Time        : 2017-05-30
...
///*============================================
//* FuncName    : av_log_default_callback
//* Description :
//* @ptr        :
//* @level      :
//* @fmt        :
...
///*============================================
//* FuncName    : missing_feature_sample
//* Description :
//* @sample        :
//* @avc           :
//* @msg           :
...
///*============================================
//* FuncName    : avpriv_request_sample
//* Description :
//* @avc        :
//* @msg        :
//* @--         :
...
///*============================================
//* FuncName    : avpriv_report_missing_feature
//* Description :
//* @avc        :
//* @msg        :
//* @--         :
